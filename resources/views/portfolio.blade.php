        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
                ...
                <div class="col mt-3">
                    ...
                    <div class="rounded-5  h-100" style="background-size: 120% auto;" class="lozad" data-background-image="{!!URL::asset($pf->project_image)!!}">
                        ...
                        <a href="{{$pf->project_link}}">
                            ...
                            <div class="card card-cover overflow-hidden text-white shadow-lg" style="background: rgba(0,0,0,0);">
                                    ...
                                    <ul class="d-flex list-unstyled mt-auto">
                                        ...
                                        <img class="lozad rounded-circle border border-white" data-src="{!! URL::asset('assets/img/sudirmansyah.jpg'); !!}" alt="Bootstrap" width="32" height="32">
